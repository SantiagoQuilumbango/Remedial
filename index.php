                    ...
                    <div class="card-body">
                        ...
                        <div class="app-brand" style="text-align: center;">
                            <span class="app-brand-logo demo">
                                <img src="./config/imagenes/unnamed.png" style="width: 50%;">
                                <h1>Login</h1>
                            </span>
                        </div>
                        <!-- /Logo -->
...
<div class="mb-3 form-password-toggle">
    ...
    <div class="input-group input-group-merge">
        <input type="password" id="correo_electronico" class="form-control" name="correo_electronico" placeholder="*************" aria-describedby="password" />
        <span class="input-group-text cursor-pointer"><i class="bx bx-hide"></i></span>
    </div>
    <p>Contraseña: mariagarcia@example.com</p>
</div>
